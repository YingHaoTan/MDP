...
CustomMotorLib::CustomMotorLib(unsigned char INA1, unsigned char INB1, unsigned char EN1DIAG1, unsigned char CS1, 
...
void CustomMotorLib::setM1Speed(int speed)
{
...
void CustomMotorLib::setM2Speed(int speed)
{
  unsigned char reverse = 0;
...
void CustomMotorLib::setSpeeds(int m1Speed, int m2Speed)
{
  setM1Speed(m1Speed);
  setM2Speed(m2Speed);
...
void CustomMotorLib::setM1Brake(int brake)
{
  // normalize brake
  if (brake < 0)
  {
...
void CustomMotorLib::setM2Brake(int brake)
{
  // normalize brake
  if (brake < 0)
  {
...
void CustomMotorLib::setBrakes(int m1Brake, int m2Brake)
{
  //setM1Brake(m1Brake);
  //setM2Brake(m2Brake);
