...
void stringCommands() {
  ...
  switch (commands[x]) {
    ...
    case 5:
      ...
      Serial << "Mid Forward IR: " << shortIrVal((irFrontReadings[1] - mfwdIrOS), 4, 37) << " blocks away, actual: " << irFrontReadings[1] << endl;
...
void sendStatusUpdate() {
  ...
  statusPayload.front2 = shortIrVal((irFrontReadings[1] - mfwdIrOS), 4, 36);
