...
/**
 * MapState is a model class that stores the CellState and conversion methods between map and robot coordinate system
 * 
 * Example:
 * <pre>
...
public class MapState {
	 ...
	 * @param point
	 */
	public void setMapCellState(Point point, CellState state) {
	...
	/**
	 * Sets all the CellState in map coordinate system to state, ignoring those that cannot be assigned the CellState
	 * @param point
	 * @param state
	 */
	...
	/**
	 * Converts a point in map coordinate system to a set of points in robot coordinate system
	 * @param mappoint
	 * @return
	 */
	...
	/**
	 * Converts a point in robot coordinate system to a set of points in map coordinate system
	 * @param robotpoint
	 * @return
	 */
	...
	/**
	 * Clones a new instance of MapState that contains identical information with this MapState instance
	 */
