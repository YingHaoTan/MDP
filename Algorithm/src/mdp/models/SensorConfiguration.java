...
/**
 * SensorConfiguration is a model class that represents a sensor configuration
 * in a robot<br /><br />
 * SensorConfiguration has a 1-dimensional coordinate that moves perpendicular
 * along the direction axis, where the center of robot is 0
 *
 * @author Ying Hao
 */
public class SensorConfiguration {
    ...
    /**
     * Gets the reliability of this sensor with 1.0 being the maximum and 0.0
     * being the minimum
     *
     * @return
     */
